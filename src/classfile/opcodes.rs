...
pub mod opc {
    ...
    pub fn can_fall_through(op: u8) -> bool {
        !matches!(op,
            ...
            athrow | tableswitch | lookupswitch | jsr | jsr_w
        )
    }
    ...
    static NAMES: &[&str] = &[
        ...
        "ixor","lxor","iinc","i2l","i2f","i2d","l2i","l2f","l2d","f2i","f2l","f2d","d2i",
        "d2l","d2f","i2b","i2c","i2s","lcmp","fcmpl","fcmpg","dcmpl","dcmpg","ifeq","ifne",
        ...
        "ireturn","lreturn","freturn","dreturn","areturn","return","getstatic","putstatic",
