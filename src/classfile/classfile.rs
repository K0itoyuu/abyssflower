...
impl ClassFile {
    ...
    pub fn parse(bytes: &[u8]) -> Result<Self> {
        ...
        for _ in 0..field_count {
            fields.push(parse_member_field(
                &mut cur,
                &constant_pool,
        ...
        for _ in 0..method_count {
            methods.push(parse_member_method(
                &mut cur,
                &constant_pool,
                (major_version, minor_version),
            )?);
    ...
    pub fn is_interface(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::INTERFACE != 0
    }
    pub fn is_abstract(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::ABSTRACT != 0
    }
    pub fn is_final(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::FINAL != 0
    }
    pub fn is_enum(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::ENUM != 0
    }
    pub fn is_annotation(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::ANNOTATION != 0
    }
    pub fn is_synthetic(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::SYNTHETIC != 0
    }
    pub fn is_module(&self) -> bool {
        self.access_flags & crate::classfile::member::flags::MODULE != 0
    }
    ...
    pub fn signature(&self) -> Option<&str> {
        for attr in &self.attributes {
            if let Attribute::Signature(s) = attr {
                return Some(s.as_str());
            }
        }
        None
