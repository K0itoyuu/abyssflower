...
impl Field {
    pub fn is_static(&self) -> bool {
        self.access_flags & flags::STATIC != 0
    }
    pub fn is_final(&self) -> bool {
        self.access_flags & flags::FINAL != 0
    }
    pub fn is_private(&self) -> bool {
        self.access_flags & flags::PRIVATE != 0
    }
    pub fn is_public(&self) -> bool {
        self.access_flags & flags::PUBLIC != 0
    }
    pub fn is_synthetic(&self) -> bool {
        self.access_flags & flags::SYNTHETIC != 0
    }
    pub fn is_enum(&self) -> bool {
        self.access_flags & flags::ENUM != 0
    }
    pub fn is_volatile(&self) -> bool {
        self.access_flags & flags::VOLATILE != 0
    }
    pub fn is_transient(&self) -> bool {
        self.access_flags & flags::TRANSIENT != 0
    }
}
...
impl Method {
    ...
    pub fn is_abstract(&self) -> bool {
        self.access_flags & flags::ABSTRACT != 0
    }
    pub fn is_native(&self) -> bool {
        self.access_flags & flags::NATIVE != 0
    }
    pub fn is_synthetic(&self) -> bool {
        self.access_flags & flags::SYNTHETIC != 0
    }
    pub fn is_bridge(&self) -> bool {
        self.access_flags & flags::BRIDGE != 0
    }
    pub fn is_varargs(&self) -> bool {
        self.access_flags & flags::VARARGS != 0
    }
    pub fn is_synchronized(&self) -> bool {
        self.access_flags & flags::SYNCHRONIZED != 0
    }
