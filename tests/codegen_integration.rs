...
mod codegen_tests {
    ...
    fn test_no_raw_opcode_leak() {
        ...
        assert!(opaque_count == 0,
            "Found {} opaque opcode placeholders in Main.class output", opaque_count);
    }
    ...
    fn test_inner_constructor_class() {
        ...
        assert!(src.contains("class TestInnerClassConstructor"),
    ...
    fn test_conflicting_lvt_namer() {
        ...
        assert!(src.contains("method(") || src.contains("Supplier"),
